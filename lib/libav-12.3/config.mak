...
SRC_PATH=.
CC_IDENT=gcc 8.1.0 (x86_64-posix-seh-rev0, Built by MinGW-W64 project)
ARCH=x86
INTRINSICS=none
CC=gcc
OBJCC=gcc
...
STRIP=strip
LN_S=ln -s -f
CPPFLAGS= -D_ISOC99_SOURCE -D_FILE_OFFSET_BITS=64 -D_LARGEFILE_SOURCE -U__STRICT_ANSI__ -D__USE_MINGW_ANSI_STDIO=1 -D__printf__=__gnu_printf__ -DPIC -DZLIB_CONST
CFLAGS=   -std=c99 -fomit-frame-pointer -g -Wdeclaration-after-statement -Wall -Wdisabled-optimization -Wpointer-arith -Wredundant-decls -Wwrite-strings -Wtype-limits -Wundef -Wmissing-prototypes -Wstrict-prototypes -Wno-parentheses -Wno-switch -Wno-format-zero-length -Wno-pointer-sign -O3 -fno-math-errno -fno-signed-zeros -fno-tree-vectorize -Werror=implicit-function-declaration -Werror=missing-prototypes -Werror=return-type -Werror=declaration-after-statement -Werror=vla -Werror=format-security -fdiagnostics-color=auto -Wno-maybe-uninitialized
OBJCFLAGS=  
ASFLAGS=   -fPIC -g
AS_C=-c
AS_O=-o $@
...
LD_PATH=-L
DLLTOOL=dlltool
LDFLAGS=  -Wl,--nxcompat -Wl,--dynamicbase -Wl,--as-needed -Wl,--warn-common -Wl,-rpath-link=libswscale:libavfilter:libavdevice:libavformat:libavcodec:libavutil:libavresample
LDEXEFLAGS=
LDSOFLAGS=
...
EXTRALIBS=-lws2_32 -lavicap32 -lm -lz -lpsapi -ladvapi32 -lshell32 
COMPAT_OBJS=
EXEOBJS=
INSTALL=install
